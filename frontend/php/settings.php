            ...
            <div style="width: 90%;">
                <div class="main">
                    <div style="text-align: center; margin: 20px">
                        <div class="align_center">
                            <div class="img_wrapper">
                                ...
                                <button class="align_center btn edit_btn">
                    ...
                    <div style="text-align: center;">
                        <form action="../../backend/sign_out.php">
                            <button class="btn submit_btn">Save</button>
                            <button class="btn submit_btn">Sign out</button>
                        </form>
                    </div>
                </div>
            </div>
