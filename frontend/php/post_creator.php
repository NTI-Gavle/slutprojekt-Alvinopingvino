                ...
                <div style="display: flex; justify-content:center;">
                    <form action="../../backend/publish_post.php" method="post" enctype="multipart/form-data" style="width:90%;">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" style="text-align: center" maxlength="100" name="title" placeholder="Title" aria-label="Post title">
                        </div>
                        <div class="input-group mb-3">
                            <textarea type="text" class="form-control grow_with_text" style="min-height:200px;" id="content_input" name="content" placeholder="Content" aria-label="Post content"></textarea>
                        </div>
                        ...
                        <div class="input-group mb-3 d-inline-flex align-items-center justify-content-center">
                            ...
                            <button type="submit" title="Publish Post" class="btn d-inline-flex align-items-center justify-content-center" aria-label="Publish post">
