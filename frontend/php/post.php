            ...
            <div style="width: 90%;">
                <main class="main" id="main-content" tabindex="-1">
                    ...
                    if ($admin_check['is_admin'] == 1 || $post['author'] == $_SESSION['user_id']) {
                        echo ('
                        <div class="mt-1">
                            <button onclick="deletePost(' . $_GET['post_id'] . ')" class="btn text-danger mr-1 d-inline-flex align-items-center justify-content-center" title="Delete post" aria-label="Delete post">
