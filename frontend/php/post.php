            ...
            <div style="width: 90%;">
                <main class="main" id="main-content" tabindex="-1">
                    ...
                    if ($is_admin || $is_author) {
                        echo ('
                            <button onclick="deletePost(' . $post['id'] . ')" class="btn text-danger me-1 d-inline-flex align-items-center justify-content-center" title="Delete post" aria-label="Delete post">
                    ...
                    ?>
                        <button class="btn d-inline-flex align-items-center justify-content-center text-danger me-1" onclick="ReportPost(<?php echo($post['id']); ?>)">Report</button>
